                        ...
                        <div className="form-row" style={{display:'grid', gridTemplateColumns:'1fr auto', alignItems:'end', gap:'15px'}}>
                            ...
                            <div className="form-group" style={{width: 'auto', position: 'relative'}}>
                                ...
                                <div className="picker-wrapper" ref={colorWrapperRef}>
                                    ...
                                    {showColorPicker && (
                                        <div className="picker-popover color-grid visible" style={{right: 0, top: '115%', display: 'grid', zIndex: 9999, position: 'absolute'}}>
                                            {availableColors.map(c => (
                                                <div key={c} className="color-swatch" style={{backgroundColor: c}} onClick={() => { setCor(c); setShowColorPicker(false); }}></div>
                                            ))}
